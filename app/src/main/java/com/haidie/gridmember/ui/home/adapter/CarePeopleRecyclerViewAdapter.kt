 ...
 * description
 */
class CarePeopleRecyclerViewAdapter(layoutResId: Int, data: ArrayList<CarePeopleListData>?) :
    BaseQuickAdapter<CarePeopleListData, BaseViewHolder>(layoutResId, data) {

    var uid = 0
    override fun convert(helper: BaseViewHolder?, item: CarePeopleListData?) {
