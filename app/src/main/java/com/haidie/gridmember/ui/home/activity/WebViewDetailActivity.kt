...
class WebViewDetailActivity : BaseActivity() {
    ...
    override fun initView() {
        ...
        mAgentWeb = AgentWeb.with(this)
                .setAgentWebParent(frame_layout_web_view_detail, LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,LinearLayout.LayoutParams.MATCH_PARENT))
