...
import com.haidie.gridmember.ui.home.activity.ProblemReportingActivity
 ...
 * description
 */
class AndroidProblemReportingInterface(problemReportingActivity: ProblemReportingActivity) {
    private val activity = problemReportingActivity
    @JavascriptInterface
